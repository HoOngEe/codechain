        ...
        switch (id) {
            ...
            case MessageType.MESSAGE_ID_PROPOSAL_BLOCK: {
                message = {
                    ...
                    priority_message: {
                        seed: {
                            seed_signer_idx: readUIntRLP(decoded[2][0][0]),
                            seed: new H256(decoded[2][0][1][0].toString("hex")),
                            proof: decoded[2][0][2]
                        },
                        priority: {
                            priority: new H256(
            ...
            case "proposalblock": {
                return [
                    ...
                    [
                        [
                            new U64(
                                this.body.priority_message.seed.seed_signer_idx
                            ).toEncodeObject(),
                            [
                                this.body.priority_message.seed.seed.toEncodeObject()
                            ],
                            this.body.priority_message.seed.proof
                        ],
                        [
